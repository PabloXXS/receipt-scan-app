-- Тестовые данные для демонстрации группировки по магазинам
-- Выполните этот скрипт в Supabase SQL Editor

-- Сначала получим ID первого пользователя из auth.users
-- Если пользователей нет, создадим тестового пользователя
DO $$
DECLARE
    test_user_id UUID;
BEGIN
